        ...
        PxrUsdKatanaAttrMap& attrs)
{
    ...
    if (UsdRiPxrBarnLightFilter f = UsdRiPxrBarnLightFilter(filterPrim)) {
        ...
        usdBuilder
            ...
            .Set("leftEdge", f.GetEdgeScaleLeftAttr())
            .Set("rightEdge", f.GetEdgeScaleRightAttr())
            .Set("topEdge", f.GetEdgeScaleTopAttr())
            .Set("bottomEdge", f.GetEdgeScaleBottomAttr())
    ...
    if (UsdRiPxrRampLightFilter f = UsdRiPxrRampLightFilter(filterPrim)) {
        ...
        usdBuilder
            .Set("beginDist", f.GetBeginDistanceAttr())
            .Set("endDist", f.GetEndDistanceAttr())
    ...
    if (UsdRiPxrRodLightFilter f = UsdRiPxrRodLightFilter(filterPrim)) {
        ...
        usdBuilder
            ...
            .Set("topEdge", f.GetEdgeScaleTopAttr())
            .Set("bottomEdge", f.GetEdgeScaleBottomAttr())
            .Set("frontEdge", f.GetEdgeScaleFrontAttr())
            .Set("backEdge", f.GetEdgeScaleBackAttr())
            .Set("saturation", f.GetColorSaturationAttr())
            .SetSpline("colorRamp", "_Colors", f.GetColorRampAPI())
